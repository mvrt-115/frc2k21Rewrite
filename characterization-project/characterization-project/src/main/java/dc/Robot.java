...
public class Robot extends TimedRobot {
  ...
  static private double GEARING = 11.244;
  ...
  public WPI_TalonFX setupWPI_TalonFX(int port, Sides side, boolean inverted) {
    ...
    switch (side) {
      ...
      case RIGHT:
        ...
        encoder = new Encoder(3, 5);
        encoder.setReverseDirection([false, false]);
  ...
  public void robotInit() {
    ...
    // create left motor
    WPI_TalonFX leftMotor = setupWPI_TalonFX(46, Sides.LEFT, false);

    WPI_TalonFX leftFollowerID9 = setupWPI_TalonFX(9, Sides.FOLLOWER, false);
    leftFollowerID9.follow(leftMotor);

    WPI_TalonFX rightMotor = setupWPI_TalonFX(48, Sides.RIGHT, false);
